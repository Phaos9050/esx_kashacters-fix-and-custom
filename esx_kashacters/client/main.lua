...
Citizen.CreateThread(function()
    while ESX == nil do
        Citizen.Wait(200)
        TriggerEvent('esx:getPhaosSharedPhaosObject', function (obj) ESX = obj end)
    end
end)
...
RegisterNUICallback("lokasyon", function(data, cb)
    local x, y, z = data.location.coord1, data.location.coord2, data.location.coord3
